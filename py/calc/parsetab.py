...
_lr_productions = [
  ...
  ('expression -> expression PLUS term','expression',3,'p_expression_plus','calc_yacc.py',10),
  ('expression -> expression MINUS term','expression',3,'p_expression_minus','calc_yacc.py',15),
  ('expression -> term','expression',1,'p_expression_term','calc_yacc.py',20),
  ('term -> term TIMES factor','term',3,'p_term_times','calc_yacc.py',25),
  ('term -> term DIVIDE factor','term',3,'p_term_div','calc_yacc.py',30),
  ('term -> factor','term',1,'p_term_factor','calc_yacc.py',35),
  ('factor -> NUMBER','factor',1,'p_factor_num','calc_yacc.py',40),
  ('factor -> LPAREN expression RPAREN','factor',3,'p_factor_expr','calc_yacc.py',45),
]
